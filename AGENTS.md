...
- No cursor animations, scroll-driven transforms or decorative animation loops. Keep native scrolling.
...
- The owner handles GitHub Pages deployment. Save revisions on a separate branch; do not update the production branch or domain configuration without an explicit request.
- Verify gameplay, keyboard and pointer controls, mobile layout, pause/resume/exit lifecycle, and browser errors before delivery.
